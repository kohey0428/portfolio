...
const About = () => {
  return (
    <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <div className="flex w-full flex-col md:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            I am a software engineering student based in Melbourne. I love to
            explore various fields of software development.
          </p>
            ...
            {infoList.map(({ icon, iconDark, title, description }, index) => (
              ...
              >
                <Image
                  ...
                  className="w-7 mt-3"
                />
                <h3 className="w-7 mt-3">{title}</h3>
          ...
          <ul className="grid grid-cols-6 sm:flex sm:items-center gap-4 sm:gap-5">
